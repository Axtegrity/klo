    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        >
          {/* Error display */}
          {(error || errorParam) && (
            <div className="mb-6 p-3 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 text-sm" role="alert" aria-describedby="signin-error">
              <span id="signin-error">
