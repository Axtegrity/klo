  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-20 md:py-28 px-6">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-klo-gold/3 blur-[120px] rounded-full pointer-events-none" />
        ...
        >
          ...
          >
            <span className="inline-flex items-center gap-2">
              <CalendarDays size={16} className="text-klo-gold" />
              March 15, 2026
            </span>
            <span className="inline-flex items-center gap-2">
              <Clock size={16} className="text-klo-gold" />
              9:00 AM - 4:00 PM
            </span>
            <span className="inline-flex items-center gap-2">
              <MapPin size={16} className="text-klo-gold" />
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-klo-gold/10 flex items-center justify-center">
                <Clock size={20} className="text-klo-gold" />
              </div>
              ...
              <motion.div key={session.title} variants={fadeUp} custom={i + 1}>
                <Card
                  className={`relative overflow-hidden ${
                    session.isActive
                      ? "border-klo-gold/40 shadow-lg shadow-klo-gold/5"
                      : ""
                  }`}
                >
                  {session.isActive && (
                  ...
                  <div className="flex flex-col md:flex-row md:items-start gap-4">
                    <div className="shrink-0 md:w-44">
                      <div className="flex items-center gap-2">
                        {session.isActive && (
                          <Radio size={14} className="text-klo-gold" />
                        )}
                        <span
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex items-center gap-4 text-xs text-klo-muted pt-1">
                        <span className="inline-flex items-center gap-1.5">
                          <User size={12} className="text-klo-gold/70" />
                          {session.speaker}
                        </span>
                        <span className="inline-flex items-center gap-1.5">
      ...
      <section className="px-6 py-16 md:py-24 bg-klo-dark/40">
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-klo-gold/10 flex items-center justify-center">
                <MessageSquare size={20} className="text-klo-gold" />
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-klo-text">
                Live Q&amp;A
              </h2>
            ...
            <Card className="mb-6">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 bg-klo-navy/50 border border-klo-slate rounded-lg px-4 py-3 text-sm text-klo-text placeholder:text-klo-muted/50 focus:outline-none focus:border-klo-gold/50 focus:ring-1 focus:ring-klo-gold/20 transition-colors"
                />
                <button
                  onClick={submitQuestion}
                  disabled={!questionInput.trim()}
                  className="shrink-0 inline-flex items-center gap-2 px-5 py-3 bg-klo-gold text-klo-navy font-semibold text-sm rounded-lg hover:bg-klo-gold/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  <Send size={16} />
                  Submit
                </button>
                ...
                >
                  <Card className="flex items-start gap-4">
                    <button
                      ...
                      className="shrink-0 flex flex-col items-center gap-1 px-2 py-1 rounded-lg hover:bg-klo-gold/10 transition-colors group"
                    >
                      <ChevronRight
                        size={16}
                        className="text-klo-muted -rotate-90 group-hover:text-klo-gold transition-colors"
                      />
      ...
      <section className="px-6 py-16 md:py-24">
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-klo-gold/10 flex items-center justify-center">
                <StickyNote size={20} className="text-klo-gold" />
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-klo-text">
                Session Notes
              </h2>
            ...
            <Card>
              <div className="space-y-3">
                <textarea
                  ...
                  rows={10}
                  className="w-full bg-klo-navy/50 border border-klo-slate rounded-lg px-4 py-3 text-sm text-klo-text placeholder:text-klo-muted/50 focus:outline-none focus:border-klo-gold/50 focus:ring-1 focus:ring-klo-gold/20 transition-colors resize-y leading-relaxed"
                />
      ...
      <section className="px-6 py-16 md:py-24 bg-klo-dark/40">
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-klo-gold/10 flex items-center justify-center">
                <Lightbulb size={20} className="text-klo-gold" />
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-klo-text">
                Key Takeaways
              </h2>
        ...
        >
          <motion.div variants={fadeUp} custom={0}>
            <Card className="relative overflow-hidden">
              {/* Accent glow */}
              <div className="absolute -top-20 -right-20 w-60 h-60 bg-klo-gold/5 blur-[80px] rounded-full pointer-events-none" />

              <div className="relative flex flex-col md:flex-row items-center gap-6 md:gap-8">
                <div className="shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br from-klo-gold/20 to-klo-gold/5 border border-klo-gold/20 flex items-center justify-center">
                  <Bot size={28} className="text-klo-gold" />
                </div>
                <div className="flex-1 text-center md:text-left">
                  ...
                  <Link
                    href="/advisor"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-klo-gold text-klo-navy font-semibold text-sm rounded-lg hover:bg-klo-gold/90 transition-colors"
                  >
                    <Bot size={16} />
                    Launch AI Advisor
      ...
      <section className="px-6 py-16 md:py-24 bg-klo-dark/40">
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-klo-gold/10 flex items-center justify-center">
                <FileDown size={20} className="text-klo-gold" />
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-klo-text">
                Resource Downloads
              </h2>
                ...
                <a href={resource.href} download>
                  <Card hoverable className="group">
                    <div className="flex items-start gap-4">
                      <div className="shrink-0 w-12 h-12 rounded-lg bg-klo-gold/10 flex items-center justify-center group-hover:bg-klo-gold/20 transition-colors">
                        <FileDown
                          size={20}
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-semibold text-klo-text group-hover:text-klo-gold transition-colors">
                          {resource.title}
                        </h3>
      ...
      <section className="px-6 py-16 md:py-20">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/assessments"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-klo-gold text-klo-navy font-semibold text-sm rounded-lg hover:bg-klo-gold/90 transition-colors"
            >
              Take an Assessment
            </Link>
            <Link
              href="/vault"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-klo-slate text-klo-text font-semibold text-sm rounded-lg hover:border-klo-gold/30 hover:text-klo-gold transition-colors"
            >
              Explore the Vault
            </Link>
            <Link
